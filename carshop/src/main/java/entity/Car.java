...
public class Car {
    ...
    public Car(int id, String tenXe, String anh, String gia, int nam, String xuatXu, String kieuDang, int choNgoi, String kichThuoc, int chieuDai, String mamXe, String lopXe, int trongLuong, String dongCo, String dungTich, String congSuat, String moMen, String hopSo, String danDong, String phanhTruoc, String phanhSau, String tocDo, float butToc, String tieuHao, String abs, String tuiKhi, String ebd, String esp) {
        this.id = id;
        this.tenXe = tenXe;
        this.anh = anh;
        this.gia = gia;
