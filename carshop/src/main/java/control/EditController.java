...
public class EditController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        editDAO.editCar(tenXe, anh, gia, nam, xuatXu, kieuDang, choNgoi, kichThuoc, chieuDai, mamXe, lopXe, trongLuong, dongCo, dungTich, congSuat, moMen, hopSo, danDong, phanhTruoc, phanhSau, tocDo, butToc, tieuHao, abs, tuiKhi, ebd, esp, id);
